...
struct PlayerEnterInLobbySC FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool playerReady() const {
    return GetField<uint8_t>(VT_PLAYERREADY, 0) != 0;
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint8_t>(verifier, VT_PLAYERREADY, 1) &&
...
struct PlayerEnterInLobbySCBuilder {
  ...
  void add_playerReady(bool playerReady) {
    fbb_.AddElement<uint8_t>(PlayerEnterInLobbySC::VT_PLAYERREADY, static_cast<uint8_t>(playerReady), 0);
  }
...
inline ::flatbuffers::Offset<PlayerEnterInLobbySC> CreatePlayerEnterInLobbySC(
  ...
  builder_.add_playerReady(playerReady);
