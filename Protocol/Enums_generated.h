...
enum PacketTypes : uint8_t {
  ...
  PacketTypes_PT_HEART_BEAT_CS = 1,
  PacketTypes_PT_PLAYER_ENTER_IN_LOBBY_CS = 2,
  PacketTypes_PT_PLAYER_READY_IN_LOBBY_CS = 3,
  PacketTypes_PT_PLAYER_CANCEL_READY_CS = 4,
  PacketTypes_PT_PLAYER_ENTER_INGAME = 5,
  PacketTypes_PT_PLAYER_INPUT_CS = 6,
  PacketTypes_PT_PLAYER_LOOK_CS = 7,
  PacketTypes_PT_PLAYER_SELECT_ROLE_CS = 8,
  PacketTypes_PT_LATENCY_CS = 9,
  ...
  PacketTypes_PT_HEART_BEAT_SC = 132,
  PacketTypes_PT_PLAYER_ENTER_IN_LOBBY_SC = 133,
  PacketTypes_PT_PLAYER_READY_IN_LOBBY_SC = 134,
  PacketTypes_PT_PLAYER_CANCEL_READY_SC = 135,
  PacketTypes_PT_REJECT_SELECTION_ROLE_SC = 136,
  PacketTypes_PT_CONFIRM_SELECTION_ROLE_SC = 137,
  PacketTypes_PT_START_SCENE_TRANSITION_SC = 138,
  PacketTypes_PT_CANCEL_SCENE_TRANSITION_SC = 139,
  PacketTypes_PT_PLAYER_CHANGE_ROLE_SC = 140,
  PacketTypes_PT_CHANGE_SCENE_SC = 141,
  PacketTypes_PT_GAME_END_SC = 142,
  PacketTypes_PT_OBJECT_APPEARED_SC = 143,
  PacketTypes_PT_OBJECT_DISAPPEARED_SC = 144,
  PacketTypes_PT_OBJECT_REMOVED_SC = 145,
  PacketTypes_PT_OBJECT_MOVE_SC = 146,
  PacketTypes_PT_OBJECT_ATTACKED_SC = 147,
  PacketTypes_PT_OBJECT_ANIMATION_CHANGED_SC = 148,
  PacketTypes_PT_GEM_INTERACT_SC = 149,
  PacketTypes_PT_GEM_CANCEL_INTERACTOIN_SC = 150,
  PacketTypes_PT_GEM_DESTROYED_SC = 151,
  PacketTypes_PT_USE_ITEM_SC = 152,
  PacketTypes_PT_ACQUIRED_ITEM_SC = 153,
  PacketTypes_PT_FIRE_PROJECTILE_SC = 154,
  PacketTypes_PT_PROJECTILE_MOVE_SC = 155,
  PacketTypes_PT_BUFF_HEAL_SC = 156,
...
inline const PacketTypes (&EnumValuesPacketTypes())[42] {
  static const PacketTypes values[] = {
    ...
    PacketTypes_PT_PLAYER_CANCEL_READY_CS,
