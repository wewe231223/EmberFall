...
public:
	...
	Texture(ComPtr<ID3D12Device> device, DXGI_FORMAT format, UINT64 width, UINT height, UINT depth, D3D12_HEAP_FLAGS heapFlag, D3D12_RESOURCE_FLAGS resourceFlag, D3D12_RESOURCE_STATES resourceState = D3D12_RESOURCE_STATE_COMMON);
